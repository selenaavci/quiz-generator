...
def run_quiz_generation(
    ...
    quiz = asyncio.run(generate_quiz(paragraphs, mcq_count, tf_count, fill_count))
...
async def run_quiz_generation_async(
    ...
    print("LLM üzerinden sorular üretiliyor bu işlem birkaç saniye sürebilir.")
    quiz = await (generate_quiz(paragraphs, mcq_count, tf_count, fill_count))
...
if __name__ == "__main__":
    ...
    run_quiz_generation(args.file, args.mcq, args.tf, args.fill, args.out)